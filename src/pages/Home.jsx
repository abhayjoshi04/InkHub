...
function Home() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      {!status && (
        <section 
          className="hero bg-cover bg-center py-32 relative custom-hero-bg" 
        ...
        >
          ...
          <Container> 
            <div className="text-center relative z-10 text-white">
              ...
              <button 
                className="px-10 py-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300"
